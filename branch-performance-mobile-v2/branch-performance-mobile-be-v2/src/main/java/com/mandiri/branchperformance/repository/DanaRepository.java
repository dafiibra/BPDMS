...
@Repository
public interface DanaRepository extends JpaRepository<FactDanaDaily, UUID> {
    ...
    @Query(value = """
        SELECT MAX(d.SNAPSHOT_DATE) FROM FACT_DANA_DAILY d
    ...
    @Query(value = """
        SELECT d.* FROM FACT_DANA_DAILY d
        WHERE d.SNAPSHOT_DATE = :snapshotDate
          AND d.BRANCH_ID = HEXTORAW(REPLACE(:branchId, '-', ''))
        """, nativeQuery = true)
    List<FactDanaDaily> findByBranchAndSnapshot(@Param("branchId") String branchId,
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    List<FactDanaDaily> findByAreaAndSnapshot(@Param("areaId") String areaId,
                                              @Param("snapshotDate") LocalDate snapshotDate);
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    List<FactDanaDaily> findByRegionAndSnapshot(@Param("regionId") String regionId,
                                                @Param("snapshotDate") LocalDate snapshotDate);
