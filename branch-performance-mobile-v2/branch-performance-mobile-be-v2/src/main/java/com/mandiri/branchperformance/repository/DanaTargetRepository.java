...
import com.mandiri.branchperformance.model.entity.FactDanaTarget;
...
@Repository
public interface DanaTargetRepository extends JpaRepository<FactDanaTarget, UUID> {
