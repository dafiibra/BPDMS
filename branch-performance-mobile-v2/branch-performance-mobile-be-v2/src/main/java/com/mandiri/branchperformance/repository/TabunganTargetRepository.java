...
import com.mandiri.branchperformance.model.entity.FactTabunganTarget;
...
@Repository
public interface TabunganTargetRepository extends JpaRepository<FactTabunganTarget, UUID> {
